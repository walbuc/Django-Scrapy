...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ranking.slug'
        db.add_column('top_ranking', 'slug', self.gf('django.db.models.fields.SlugField')(default=1, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ranking.slug'
        db.delete_column('top_ranking', 'slug')
